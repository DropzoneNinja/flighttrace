...
public struct ExportConfiguration: Sendable {
    ...
    public var videoSettings: [String: Any] {
        ...
        var settings: [String: Any] = [
            ...
            AVVideoWidthKey as String: dims.width,
            AVVideoHeightKey as String: dims.height,
        ]

        // Compression properties
        var compressionProperties: [String: Any] = [
            AVVideoAverageBitRateKey as String: bitrate,
            AVVideoExpectedSourceFrameRateKey as String: frameRate.rawValue,
            AVVideoMaxKeyFrameIntervalKey as String: frameRate.rawValue * 2, // Keyframe every 2 seconds
        ]

        // Profile level (H.264 specific)
        if codec == .h264 {
            compressionProperties[AVVideoProfileLevelKey as String] = AVVideoProfileLevelH264HighAutoLevel
        }

        settings[AVVideoCompressionPropertiesKey as String] = compressionProperties
