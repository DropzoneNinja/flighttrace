...
public final class CanvasViewModel {
    ...
    /// - Parameters:
    ///   - id: The instrument ID to select
    ///   - activateResize: Whether to enable resize mode immediately
    public func selectInstrument(id: UUID, activateResize: Bool = true) {
        selectedInstrumentID = id
        resizeMode = activateResize
    }
