...
public struct MainWindowView: View {
    ...
    private var canExport: Bool {
        // Can export if we have a timeline with data
        viewModel.timelineEngine.track != nil && viewModel.timelineEngine.duration > 0
    }
...
public struct FlightTraceCommands: Commands {
    ...
    public var body: some Commands {
        ...
        CommandGroup(replacing: .newItem) {
            ...
            .keyboardShortcut("e", modifiers: [.command])
            .disabled(viewModel?.timelineEngine.track == nil || exportAction == nil)
        }
