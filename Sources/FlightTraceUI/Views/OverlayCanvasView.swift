...
public struct OverlayCanvasView: View {
    ...
    private func renderInstrument(
        ...
        let renderContext = RenderContext(
            ...
            currentTime: timelinePosition.gpxTimestamp,
            isPreview: true
        )
        ...
        // CRITICAL: Wrap CGContext in NSGraphicsContext so NSAttributedString.draw() works
        // We've already flipped the CGContext, so we need to tell NSGraphicsContext it's flipped
        #if canImport(AppKit)
